            ...
            if (!validateName(name) || !validateEmail(email)) {
                ...
                try {
                    await fetch('http://localhost:9000/student/create', {
                        ...
                        body: JSON.stringify({"name": `${name}`, "email": `${email}`, "universityId": parseInt(uid),"dob":`${dob}`})
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" id="dob" placeholder="Date of Birth" value = {dob} onChange = {(e)=> setDob(e.target.value)} />
                        </div>
